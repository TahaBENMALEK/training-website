  ...
  return (
    <div className="h-auto w-full bg-gray-800">
        <div className="flex p-4">
            <img src={workshop} alt="Workshop" className="h-auto  w-[40%] rounded-lg shadow-lg border-2 border-white hover:scale-105 transition-transform duration-300 object-cover"></img>
